    ...
    <div className="container mx-auto max-w-6xl px-4 py-12">
      ...
      <section className="relative py-16">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">Build with the Gitsink API</h1>
  ...
  -H "Authorization: Bearer YOUR_API_KEY"`}</code>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b">
                  <th className="px-4 py-3 text-left font-medium text-muted-foreground w-[30%]">Endpoint</th>
                  <th className="px-4 py-3 text-left font-medium text-muted-foreground w-[15%]">Method</th>
                  <th className="px-4 py-3 text-left font-medium text-muted-foreground">Description</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b">
                  <td className="px-4 py-3 font-mono text-sm">/projects</td>
                  ...
                  <td className="px-4 py-3">List all synced GitHub projects with pagination support</td>
                </tr>
                <tr className="border-b">
                  <td className="px-4 py-3 font-mono text-sm">/sync</td>
                  <td className="px-4 py-3">
                  ...
                  <td className="px-4 py-3">Trigger a manual sync of your GitHub repositories</td>
                </tr>
                <tr className="border-b">
                  <td className="px-4 py-3 font-mono text-sm">/projects/:id</td>
                  <td className="px-4 py-3">
                    <span className="inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold border-transparent bg-blue-500/10 text-blue-500">
                      GET
                    </span>
                  ...
                  <td className="px-4 py-3">Get detailed metadata for a specific project</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section id="sandbox">
          <div className="overflow-hidden rounded-lg bg-gradient-to-br from-primary/5 to-primary/10">
            <div className="flex flex-col items-center justify-between gap-6 p-8 text-center sm:flex-row sm:text-left">
              <div>
